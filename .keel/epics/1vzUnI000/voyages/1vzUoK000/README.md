...
> Define and deliver persistent node registration, heartbeat freshness, and imported fleet inventory contracts for the hosted control plane.
...
| Title | Type | Status |
|-------|------|--------|
| [Define Durable Hosted Registry Contract](../../../../stories/1vzUq5000/README.md) | feat | done |
