...
> Define the first cluster-first local K3s operator workflow with offline Port-owned bootstrap, kubeconfig and health output, and explicit multi-node or AWS follow-on boundaries.
