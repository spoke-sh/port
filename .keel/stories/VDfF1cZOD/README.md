...
- [x] [SRS-03/AC-01] `port doctor`, validation, and operator docs keep attached-volume backend, host-path, machine, and ownership detail explicit instead of collapsing the storage contract back into rootfs language. <!-- [SRS-03/AC-01] verify: sh -c 'cd /home/alex/workspace/spoke-sh/port && cargo test -q doctor_attached_volume_guidance && /home/alex/.nix-profile/bin/rg -n "attached volume|host-file|host path|ownership" README.md docs CONFIGURATION.md', proof: ac-1.log -->
