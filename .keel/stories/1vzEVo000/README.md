...
- [ ] [SRS-03/AC-01] Hosted `port machine ...` and `port guest ...` commands execute through the live hosted HTTP path whenever a machine resolves to `hosted-control-plane` mode. <!-- [SRS-03/AC-01] verify: cargo test -q -p port-cli, proof: ac-1.log -->
