...
- [ ] [SRS-02/AC-01] A running node agent registers its node against the hosted control plane and refreshes freshness state while it is serving. <!-- [SRS-02/AC-01] verify: cargo test, proof: ac-1.log -->
<!-- verify: command, SRS-02:end, proof: ac-2.log -->
- [ ] [SRS-02/AC-02] Registration failures such as unreachable control planes, auth mismatches, or stale registration are surfaced explicitly in hosted runtime proof output. <!-- [SRS-02/AC-02] verify: cargo test, proof: ac-2.log -->
